<template>
    <div class="layout-topbar">
        <div class="topbar-left">
            ...
            <img id="logo-mobile" class="mobile-logo" src="images/layout/logo-dark.svg" alt="diamond-layout" />
        </div>
            ...
            <ul class="topbar-menu">
                ...
                <li class="profile-item" :class="{ 'active-menuitem fadeInDown': topbarUserMenuActive }">
                    <a href="#" @click="onTopbarUserMenuButtonClick">
                        <img src="images/avatar/profile.jpg" alt="diamond-layout" class="profile-image" />
