            ...
            <div class="card">
                ...
                <Toolbar class="p-mb-4">
                    ...
                    <template v-slot:right>
                        <Button label="Questionário de Sucesso" icon="pi pi-plus" class="p-button-success p-mr-2" @click="novoQuest" />
                ...
                >
                    ...
                    <Column field="qtdpedidos" header="Qtd.Pedidos" :sortable="true" class="p-text-right">
                        <template #body="slotProps">
                    ...
                    <Column field="valorpedidos" header="Valor Pedidos" :sortable="true" class="p-text-right">
                        <template #body="slotProps">
                ...
                <Dialog v-model:visible="editDialog" :style="{ width: '450px' }" header="Editar" :modal="true" class="p-fluid">
                    <div class="p-field">
                        ...
                        <InputText id="nome" v-model.trim="cliente.nome" required="true" autofocus :class="{ 'p-invalid': submitted && !cliente.nome }" />
                        <small class="p-invalid" v-if="submitted && !cliente.nome">Nome é obrigatório.</small>
                    </div>
                    <div class="p-field">
                        <label for="cnpj">CNPJ</label>
                        <InputText id="cnpj" v-model.trim="cliente.cnpj" required="true" autofocus :class="{ 'p-invalid': submitted && !cliente.cnpj }" />
                        <small class="p-invalid" v-if="submitted && !cliente.cnpj">CNPJ é obrigatório.</small>
                    </div>
                    ...
                    <div class="p-field">
                        ...
                        <small class="p-invalid" v-if="submitted && !cliente.status">Status é obrigatório.</small>
                    </div>
                    ...
                    <div class="p-field">
                        ...
                        <div class="p-formgrid p-grid">
                            <div class="p-field-radiobutton p-col-6">
                                <RadioButton id="category1" name="categoria" value="categoria1" v-model="cliente.categoria" />
                                <label for="categoria1">Categoria 1</label>
                            </div>
                            <div class="p-field-radiobutton p-col-6">
                                <RadioButton id="category2" name="categoria" value="categoria2" v-model="cliente.categoria" />
                                <label for="categoria2">Categoria 2</label>
                            </div>
                            <div class="p-field-radiobutton p-col-6">
                                <RadioButton id="category3" name="categoria" value="categoria3" v-model="cliente.categoria" />
                                <label for="categoria3">Categoria 3</label>
                            </div>
                            <div class="p-field-radiobutton p-col-6">
                                <RadioButton id="category4" name="categoria" value="categoria4" v-model="cliente.categoria" />
                    ...
                    <div class="p-formgrid p-grid">
                        ...
                        <div class="p-field p-col">
                            ...
                            <InputNumber id="limite" v-model="cliente.limite" mode="currency" currency="BRL" locale="pt-BR" />
                        </div>
                ...
                <Dialog v-model:visible="deleteDialog" :style="{ width: '450px' }" header="Confirmar" :modal="true">
                    <div class="confirmation-content">
                        <i class="pi pi-exclamation-triangle p-mr-3" style="font-size: 2rem" />
                        <span v-if="cliente">Confirma deletar todos os registros selecionados?</span>
                    </div>
                    <template #footer>
    ...
    methods: {
        ...
        save() {
            ...
            if (
                ...
                if (this.cliente.id) { // Save editted cliente
                    this.cliente.status = this.cliente.status.value ? this.cliente.status.value : this.cliente.status;
                    ...
                    this.cliente.status = this.cliente.status ? this.cliente.status.value : 'A';
        ...
        deleteSelectedRegs() {
            ...
            this.service.delete(ids).then((id) => {
                this.clientes = this.clientes.filter((val) => !id.includes(val.id.toString()));
